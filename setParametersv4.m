function [param] = setParametersv4(opCentx,opCentz)
%General Parameters
%scan range
...
param.opticCentreP = [opCentx,opCentz]; %in pixels
...
%Object coordinates
param.x = -param.nPx/2+1:param.nPx/2; % number of voxels
param.y = -param.nPx/2+1:param.nPx/2;
param.z = -param.nPx/2+1:param.nPx/2;
